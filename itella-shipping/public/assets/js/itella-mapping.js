...
var itellaMapping = /*#__PURE__*/function () {
  ...
  return _createClass(itellaMapping, [{
    key: "observeRemoval",
    ...
    key: "toggleDropdown",
    value: function toggleDropdown(select, drpd) {
      select.classList.toggle('open');
      drpd.setAttribute('aria-expanded', select.classList.contains('open'));
    }
  }, {
    key: "closeDropdown",
    value: function closeDropdown(select, drpd) {
      select.classList.remove('open');
      drpd.setAttribute('aria-expanded', 'false');
      this.clearHighlight(select);
    }
  }, {
    key: "highlightDropdownItem",
    value: function highlightDropdownItem(items, index) {
    ...
    key: "clearHighlight",
    value: function clearHighlight(container) {
      var highlighted = container.querySelectorAll('li.highlighted');
    ...
    value: function dropdownListeners() {
      ...
      select.addEventListener('keydown', function (e) {
        var items = select.querySelectorAll('li.itella-terminal-data');
        if (!items.length) return;
        var highlighted = select.querySelector('li.itella-terminal-data.highlighted');
        var active = select.querySelector('li.itella-terminal-data.active');
        var index = highlighted ? Array.prototype.indexOf.call(items, highlighted) : active ? Array.prototype.indexOf.call(items, active) : -1;
        if (e.key === 'ArrowDown') {
          e.preventDefault();
    ...
    !function (e) {
      ...
      var t = L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        zoomToShowLayer: function zoomToShowLayer(e, t) {
          ...
          var _i = function i() {
            !e._icon && !e.__parent._icon || this._inZoomAnimation || (this._map.off("moveend", _i, this), this.off("animationend", _i, this), e._icon ? t() : e.__parent._icon && (this.once("spiderfied", t, this), e.__parent.spiderfy()));
          };
          e._icon && this._map.getBounds().contains(e.getLatLng()) ? t() : e.__parent._zoom < Math.round(this._map._zoom) ? (this._map.on("moveend", _i, this), this._map.panTo(e.getLatLng())) : (this._map.on("moveend", _i, this), this.on("animationend", _i, this), e.__parent.zoomToBounds());
        },
