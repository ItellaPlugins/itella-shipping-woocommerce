  ...
  _createClass(itellaMapping, [{
    ...
    value: function attachListeners() {
      ...
      this._markerLayer.on('clusterclick', function (a) {
        ...
        a.layer.zoomToBounds(); //_this.setMapView(_this._map.getCenter(), _this._map.getZoom());
      });

      this._markerLayer.on('click', function (e) {
        _this.removeActiveClass(); // _this._markerLayer.eachLayer(function (icon) {
    ...
    value: function setActiveMarkerByTerminalId(id) {// No longer used
    ...
    value: function setMapView(targetLatLng, targetZoom) {
      if (window.matchMedia("(min-width: 769px)").matches) {
        ...
        this._map._viewport.style.left = offset + 'px'; // let targetPoint = this._map.project(targetLatLng, targetZoom).subtract([offset, 0]);
